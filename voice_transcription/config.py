...
CREATE_MIND_MAP = _env_bool("VOICE_TRANSCRIPTION_CREATE_MIND_MAP", True)
SPEAKER_PROFILE_SUGGESTIONS = _env_bool("VOICE_TRANSCRIPTION_SPEAKER_PROFILE_SUGGESTIONS", True)
SUMMARY_TEMPLATE = os.environ.get("VOICE_TRANSCRIPTION_SUMMARY_TEMPLATE", "meeting")
